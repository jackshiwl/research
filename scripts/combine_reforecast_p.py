...
dsmerged2 = xr.open_mfdataset('./reforecast_v3_ens_apcp/apcp_sfc_*_p02.nc',concat_dim='time',combine='nested')
dsmerged3 = xr.open_mfdataset('./reforecast_v3_ens_apcp/apcp_sfc_*_p03.nc',concat_dim='time',combine='nested')
dsmerged4 = xr.open_mfdataset('./reforecast_v3_ens_apcp/apcp_sfc_*_p04.nc',concat_dim='time',combine='nested')
...
combine_reforecast_p(dsmerged2, 'GEFSv12-Reforecast_apcp_p02.nc')
combine_reforecast_p(dsmerged3, 'GEFSv12-Reforecast_apcp_p03.nc')
combine_reforecast_p(dsmerged4, 'GEFSv12-Reforecast_apcp_p04.nc')
