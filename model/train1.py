...
from Network1 import Generator
...
def train(epochs, batch_size):
 ...
 #   loss=MSE_LOSS(image_shape_hr)
    ...
    generator.compile(loss=class_loss, optimizer = Adam(learning_rate=0.0001, beta_1=0.9),metrics='mae')
    ...
    for e in range(1, epochs+1):
        ...
        for _ in tqdm(range(batch_count)):
            ...
            gen_loss=generator.train_on_batch(x_lr, y_class)
        gen_loss = str(gen_loss)
        val_loss = generator.evaluate(x_val_lr, y_val_class, verbose=0)
